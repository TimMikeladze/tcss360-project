...
public class ConferenceManager {
    ...
    public static int createConference(final String name, final String location,
            final Date date, final int programChairID) {
        ...
        int id = Database
                ...
                .addParameter("date", date).addParameter("programChairID", programChairID)
        ...
        Database.getInstance()
                ...
                .addParameter("permissionID", PermissionLevel.PROGRAM_CHAIR).executeUpdate();
        return id;
    }
    ...
    public static void addUserToConference(final int conferenceID, final int userID,
        ...
        if (conferenceExists(conferenceID)) {
            Database.getInstance()
                    ...
                    .addParameter("permissionID", permissionID.getPermission()).executeUpdate();
        }
        else {
    ...
    public static void removeUserFromConference(final int conferenceID, final int userID) {
        Database.getInstance()
                ...
                .addParameter("userID", userID).addParameter("conferenceID", conferenceID)
                .executeUpdate();
    }
