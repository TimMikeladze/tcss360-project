...
public class ConferenceManager {
	 ...
	 */
	public static int createConference(final String name,
			final String location, final Date date, final int programChairID) {
		int id = Database
				.getInstance()
				.createQuery(
	 ...
	 * @param userID
	 *            The id of the user being added
	 * @param permissionID
	 *            The permission of the user being added
	 * @throws DatabaseException
	 */
	public static void addUserToConference(final int conferenceID,
			final int userID, final PermissionLevel permissionID)
			throws DatabaseException {
	 ...
	 */
	public static void removeUserFromConference(final int conferenceID,
			final int userID) {
		Database.getInstance()
				.createQuery(
