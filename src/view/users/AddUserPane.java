 ...
 * @version 11-23-2013
 */
public class AddUserPane extends Stage implements EventHandler {
    ...
    public AddUserPane(final Stage owner, final ProgressSpinnerCallbacks progressSpinnerCallbacks,
    ...
    private void populateTable() {
        if (listOfUser != null) {
            for (User u : listOfUser) {
                //TODO add permission
                usersTable.add(new UserRow(u.getID(), u.getFirstName(), u.getLastName()));
            }
