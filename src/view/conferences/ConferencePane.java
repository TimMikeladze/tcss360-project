...
public class ConferencePane extends GenericPane<GridPane> implements EventHandler {
    ...
    private void create() {
        ...
        System.out.println(LoggedUser.getInstance().getHighestPermission());
        if(Permissions.hasPermission(ConferenceManager.class, "addSubProgramChairToConference", LoggedUser.getInstance().getPermissions())) {
        ...
        protected Task<String> createTask() {
            return new Task<String>() {
                ...
                protected String call() {
                    try {
                        LoggedUser.getInstance().setPermissions(Permissions.getPermissionsForConference(conferenceID, LoggedUser.getInstance().getUser().getID()));
