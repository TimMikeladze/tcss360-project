...
public class MainPane extends BorderPane {
    ...
    /**
     * Constructs a new MainPane pane that extends BorderPane and displays the main
     * user interface that all other panes are placed upon.
     */
    public MainPane() {
        this.setTop(topPane());
    ...
    /**
     * Creates a pane that runs horizontal along the windows north border and displays
     * the users name along with the logout button.
    ...
    private TilePane leftPane() {
        ...
        tilePane.getChildren().addAll(homeButton, conferencesButton, submissionsButton, usersButton, messagesButton);
    ...
    private StackPane centerPane() {
        ...
        stackPane.getChildren().add(new HomePane());
